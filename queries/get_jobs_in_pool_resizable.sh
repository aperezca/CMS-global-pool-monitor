...
echo $date_s $jobs_1 $jobs_2 $jobs_3 $jobs_4 $jobs_5 $jobs_6 $jobs_7 $jobs_8 $jobs_9 $jobs_10>>/crabprod/CSstoragePath/aperez/out/resizable_3_10_jobs
echo $date_s $jobcores_1 $jobcores_2 $jobcores_3 $jobcores_4 $jobcores_5 $jobcores_6 $jobcores_7 $jobcores_8 $jobcores_9 $jobcores_10>>/crabprod/CSstoragePath/aperez/out/resizable_3_10_jobcores

...
cat /home/aperez/status/cores_fresh_glideins.txt |grep Claimed |grep Dynamic> /home/aperez/status/claimed_fresh_glideins.txt
cat /home/aperez/status/cores_retiring_glideins.txt |grep Claimed |grep Dynamic> /home/aperez/status/claimed_retiring_glideins.txt

...
OUT=$HTMLDIR/$long"volunteer_pool_collector_"$int"h.html"
...
#-------------
tail -n $n_lines $OUTDIR/collector_volunteer_pool|awk -v var="$ratio" 'NR % var == 0' |sort >$WORKDIR/status/input_volunteer_collector$int
...
<body>
    ...
    <div id="header">
        ...
        <a href="'$WEBPATH'volunteer_pool_collector_24h.html">24h</a>
        <a href="'$WEBPATH'volunteer_pool_collector_168h.html">1week</a>
        <a href="'$WEBPATH'longvolunteer_pool_collector_720h.html">1month</a>
        <br><br>
        </h2>
    </div>

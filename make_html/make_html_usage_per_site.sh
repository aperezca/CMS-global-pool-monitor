...
OUT="/crabprod/CSstoragePath/aperez/T2s/"$long"multicore_usage_"$mysite"_"$int"h.html"
echo '<html>
<head>
...
<body>
    <div id="header">
        <h2>MULTICORE PILOT USAGE OF CPU CORES AT CMS '$mysite' site for the last '$int' hours<br>
        <a href="http://submit-3.t2.ucsd.edu/CSstoragePath/aperez/T2s/multicore_occupancy_t2s_'$int'h.html">(OCCUPANCY)</a>
        <a href="http://submit-3.t2.ucsd.edu/CSstoragePath/aperez/T2s/multicore_factory_t2s_'$int'h.html">(FACTORY STATUS)</a>
        <a href="http://submit-3.t2.ucsd.edu/CSstoragePath/aperez/T2s/multicore_frontend_t2s_'$int'h.html">(FRONT-END)</a>
        </h2>

	</h2>
    </div>
<a href="http://submit-3.t2.ucsd.edu/CSstoragePath/aperez/T2s/multicore_usage_t2s_24h.html">24h</a>
<a href="http://submit-3.t2.ucsd.edu/CSstoragePath/aperez/T2s/multicore_usage_t2s_168h.html">1week</a>
<a href="http://submit-3.t2.ucsd.edu/CSstoragePath/aperez/T2s/longmulticore_usage_t2s_720h.html">1month</a>
<br>

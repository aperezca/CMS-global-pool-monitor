...
tail -n $n_lines $OUTDIR/out/jobs_size|awk -v var="$ratio" 'NR % var == 0' >$WORKDIR/status/input_jobs_size$int
...
tail -n $n_lines $OUTDIR/out/jobs_size_prod |awk -v var="$ratio" 'NR % var == 0'>$WORKDIR/status/input_jobs_size_prod$int
while read -r line; do
        time=$(echo $line |awk '{print $1}')
        let timemil=1000*$time
        content=$(echo $line |awk '{print $2", "$3}')
...
tail -n $n_lines $OUTDIR/out/jobcores_size_prod|awk -v var="$ratio" 'NR % var == 0' >$WORKDIR/status/input_jobcores_size_prod$int
while read -r line; do
        time=$(echo $line |awk '{print $1}')
        let timemil=1000*$time
        content=$(echo $line |awk '{print $2", "$3}')
...
tail -n $n_lines $OUTDIR/out/jobs_size_crab|awk -v var="$ratio" 'NR % var == 0' >$WORKDIR/status/input_jobs_size_crab$int
while read -r line; do
        time=$(echo $line |awk '{print $1}')
        let timemil=1000*$time
        content=$(echo $line |awk '{print $2", "$3}')
...
tail -n $n_lines $OUTDIR/out/jobcores_size_crab|awk -v var="$ratio" 'NR % var == 0' >$WORKDIR/status/input_jobcores_size_crab$int
while read -r line; do
        time=$(echo $line |awk '{print $1}')
        let timemil=1000*$time
        content=$(echo $line |awk '{print $2", "$3}')
...
tail -n $n_lines $OUTDIR/out/jobs_size_other|awk -v var="$ratio" 'NR % var == 0' >$WORKDIR/status/input_jobs_size_other$int
while read -r line; do
        time=$(echo $line |awk '{print $1}')
        let timemil=1000*$time
        content=$(echo $line |awk '{print $2", "$3}')
...
tail -n $n_lines $OUTDIR/out/jobcores_size_other|awk -v var="$ratio" 'NR % var == 0' >$WORKDIR/status/input_jobcores_size_other$int
while read -r line; do
        time=$(echo $line |awk '{print $1}')
        let timemil=1000*$time
        content=$(echo $line |awk '{print $2", "$3}')

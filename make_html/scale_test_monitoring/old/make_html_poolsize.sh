...
OUT=$OUTDIR"/HTML/"$long"test_pool_size_"$int"h.html"
echo '<html>
<head>
<title>CMS test pool running glideins monitor</title>
<!--Load the AJAX API-->
...
var options_poolidle = {
        title: 'Test pool busy and idle cores per type of pilot',
        isStacked: 'true',
        explorer: {},
        'height':500,
...
echo "      ]);
var options_pooleff = {
        title: 'Test pool pilot occupation percentages',
        isStacked: 'false',
        explorer: {},
        'height':500,
...
var options_mcoreidle = {
        title: 'Test pool idle cores in multicore pilots: past retire time, not enough memory, usable claimed and unclaimed',
        isStacked: 'true',
        explorer: {},
        'height':500,
...
echo "      ]);
var options_FE = {
        title: 'Test pool FE pressure in requested_idle_glideins X N_cores',
        isStacked: 'true',
        explorer: {},
        'height':500,

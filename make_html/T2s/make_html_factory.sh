...
OUT="/crabprod/CSstoragePath/aperez/HTML/T2s/"$long"multicore_factory_t2s_"$int"h.html"
echo '<html>
<head>
...
<body>
    <div id="header">
        <h2>FACTORY STATUS OF MULTICORE PILOTS AT CMS T2s for the last '$int' hours, updated at '$(date -u)'<br>
...
<a href="http://submit-3.t2.ucsd.edu/CSstoragePath/aperez/HTML/T2s/multicore_factory_t2s_24h.html">24h</a>
<a href="http://submit-3.t2.ucsd.edu/CSstoragePath/aperez/HTML/T2s/multicore_factory_t2s_168h.html">1week</a>
<a href="http://submit-3.t2.ucsd.edu/CSstoragePath/aperez/HTML/T2s/longmulticore_factory_t2s_720h.html">1month</a>
<br>
